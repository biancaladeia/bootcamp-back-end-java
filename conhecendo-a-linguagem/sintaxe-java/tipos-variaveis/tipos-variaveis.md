...
double salarioMinimo = 2500.33; //tipo "double", nome "salarioMinimo", valor 2500.33
```
...
Muitas das vezes criamos uma variável, definimos um valor correspondente, manipulamos esta variável e temos consciência de seu valor na aplicação. Mas, cuidado! Java é fortemente "tipado".
